...
public class LocalisationService {
    ...
    private static final Utf8ResourceBundle catalan;
    private static final Utf8ResourceBundle czech;
    private static final Utf8ResourceBundle deutch;
    private static final Utf8ResourceBundle english;
    private static final Utf8ResourceBundle spanish;
    private static final Utf8ResourceBundle french;
    ...
    static {
        synchronized (lock) {
        	...
        	catalan = new Utf8ResourceBundle(STRINGS_FILE, new Locale("ca", "ES"));
            supportedLanguages.add(new Language("ca", "Català"));

            czech = new Utf8ResourceBundle(STRINGS_FILE, new Locale("cz", "CZ"));
            supportedLanguages.add(new Language("cz", "Čeština"));
            
            deutch = new Utf8ResourceBundle(STRINGS_FILE, new Locale("de", "DE"));
            supportedLanguages.add(new Language("de", "Deutsche"));
        	
        	english = new Utf8ResourceBundle(STRINGS_FILE, Locale.ROOT);
            ...
            french = new Utf8ResourceBundle(STRINGS_FILE, new Locale("fr", "FR"));
            ...
            supportedLanguages.add(new Language("pt", "Portuguès"));
    ...
    public static String getString(String key, String language) {
        String result;
        try {
            switch (StringUtils.substring(language.toLowerCase(), 0, 2) ) {
            case "ca":
            	result = catalan.getString(key);
            	break;
            case "cs":
            	result = czech.getString(key);
            	break;
            case "de":
            	result = deutch.getString(key);
            	break;
            case "en":
            	result = english.getString(key);
            	break;
